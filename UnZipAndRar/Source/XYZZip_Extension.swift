...
public func 压缩(filePath路径组:[URL],压缩文件文件名:String = "archive")  {
...
public var 解压计数器 = 0
public func 解压缩(filePath路径组:[URL]) -> [URL] {
    解压计数器 += 1
    var 解压完成路径URL集合 = [URL]()
...
public func 高级压缩(需要压缩的文件路径url:[URL],文件名:String = "archive",压缩成的类型:String = "lmr",密码:String = "1",压缩终点:URL)  {
...
public func 高级解压缩(filePath需要解压URL路径:URL,密码:String = "1",解压终点:URL)  {
